...
int main() {
    string student[3] = {"1191301958", "1171100932", "11161100657"};

//    int i=0;
//    for (int i=0;i<3;i++) { // bruh initialised variable i twice
//        do {
...
//    }
    ...
    // Generate planet_ID, coordinate-x, coordinate-y, coordinate-z, item-weight, item-profit
